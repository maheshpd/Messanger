...
//            }
            ...
            FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password, completion: {authResult,error in
                ...
                let chatUse = ChatAppUser(firstName: firstName, lastname: lastName,
                emailAddress: email)
                
                DatabaseManager.shared.insertUser(with: chatUse, completion: { success in
                    if success {
                        //upload image
                        ...
                        let fileName = chatUse.profilePictureFileName
